...
export default function TariqPage() {
  ...
  const primaryColor = '#FFD600'; // Color primario de Tariq
  ...
  const saveToBrain = async (text: string) => {
    ...
    const body = {
      ...
      title: '',
      content: text,
      source: 'chat-tariq', // Fuente específica para Tariq
      category: null,
    };
              ...
              {msg.from !== 'user' && ( // Solo muestra el botón para mensajes del asistente
                <button
                  ...
                  style={{
                    position: 'absolute',
                    top: '8px',
                    right: '-36px', // Ajusta si es necesario para el diseño de Tariq
