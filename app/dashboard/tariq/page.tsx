...
export default function TariqPage() {
  ...
  const primaryColor = '#FFD600'; // Amarillo brillante (como referencia a la card)
      ...
      <section style={{
        ...
        <form
          onSubmit={(e) => {
            ...
            if (!value) return;
            setMessages(prev => [...prev, { from: 'user', text: value }, { from: 'tariq', text: 'Let me look into that for you...' }]);
            input.value = '';
          }}
          style={{
            display: 'flex',
